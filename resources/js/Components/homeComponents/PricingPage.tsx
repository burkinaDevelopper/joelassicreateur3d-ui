...
const pricingPlans = [
  {
    name: 'Basic',
    description: 'PRIX FINAL EN US$ / PAS DE FRAIS CACHÉS',
    monthlyPrice: 69,
    annualPrice: 49,
    link: '/contact',
    features: [
  ...
  },
  {
    name: 'Premium',
    description:
      'PRIX FINAL EN US$ / PAS DE FRAIS CACHÉS',
    monthlyPrice: 2499,
    annualPrice: 1666,
    link: '/contact',
    features: [
...
const Pricing = () => {
  ...
  const PricingCards = () => (
    <div className="relative z-10 mx-auto flex w-full max-w-[696px] flex-col gap-8 lg:flex-row lg:gap-4">

       ...
       <AdminLayout>
          <main className='w-full'>
            ...
            <Card className="w-[350px]">
                <CardHeader>
                    <CardTitle>Banner de la page d'acceuil</CardTitle>
                    <CardDescription>possible de faire glisser depose. tail (2132, 334)</CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <Table>
                    ...
                    <TableBody>
                        {images && images.map((image,index)=>(  
                             <CardImage image={image} key={index} link={"homebanner.destroy"} />
                          ))}
                    </TableBody>
                </Table>
            </div>
